...
public class MovieRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static int jcindicator = 0;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (jcindicator == 0){
            ...
            ((SpecificMovieViewHolder)viewHolder).tvTrackNameDetail.setText(mMovies.get(i).getTrackName());
            ((SpecificMovieViewHolder)viewHolder).tvPrimaryGenreNameDetail.setText(mMovies.get(i).getPrimaryGenreName());
            ((SpecificMovieViewHolder)viewHolder).tvLongDescriptionDetail.setText(mMovies.get(i).getLongDescription());
