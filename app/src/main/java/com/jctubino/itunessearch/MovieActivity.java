...
public class MovieActivity extends BaseActivity {
    ...
    private void subscribeObservers(){
        ...
        mMovieViewModel.isMovieRequestTimedOut().observe(this, new Observer<Boolean>() {
            ...
            public void onChanged(@Nullable Boolean aBoolean) {
                if(aBoolean && !mMovieViewModel.didRetrieveRecipe()){
    ...
    private void searchMoviesApi(int id){
        //if(pageNumber==0){
        mMovieViewModel.searchMovieById(id);
    }

    // API Tester
    private void testRetroFitRequest(){
        searchMoviesApi(mMovieViewModel.getMovieId());
    }
